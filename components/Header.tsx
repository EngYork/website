...
const Header: React.FC = () => {
  return (
    <header className="hidden w-full p-2 bg-slate-400 dark:bg-slate-900 shadow-2xl shadow-gray-400 dark:shadow-gray-900 sm:flex flex-row justify-between items-center relative">
      <Link href="/">
